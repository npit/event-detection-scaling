...
public class StructUtils {
    ...
    public static void printArticleRDDPairs(JavaPairRDD<Tuple4<String, String, String, Long>, Tuple4<String, String, String, Long>> rddPairs, int items ) {
    ...
    public static void printArticleRDDPairs(JavaPairRDD<Tuple4<String, String, String, Long>, Tuple4<String, String, String, Long>> rddPairs) {



        List<Tuple2<Tuple4<String, String, String, Long>, Tuple4<String, String, String, Long>>> takeN = rddPairs.collect();
        System.out.println("\n\nPAIRS:\n");
        for (Tuple2<Tuple4<String, String, String, Long>, Tuple4<String, String, String, Long>> eachPair: takeN) {
            System.out.println("" + eachPair._1._1() + " | " + eachPair._2._1());
            System.out.println("" + eachPair._1._2() + " | " + eachPair._2._2());
        }
    }

    public static void printArticlesRDD(JavaRDD<Tuple4<String, String, String, Long>> args)
    {
    ...
    public static void printArticlePairs(List<Tuple2<Tuple4<String, String, String, Long>,Tuple4<String, String, String, Long>>> listarticlepairs)
    {
        System.out.println("Article pairs list:");
        int count =0;
        for (Tuple2<Tuple4<String,String,String,Long>,Tuple4<String,String,String,Long>> t : listarticlepairs)
        {
            System.out.printf("%d : %s | %s\n",++count, t._1()._2(), t._2()._2());
        }
    }
    public static void printArticle(Tuple4<String, String, String, Long> t)
    {
        System.out.println("Article tuple4: " + t._1() + " ||| " + t._2());
    }
}
