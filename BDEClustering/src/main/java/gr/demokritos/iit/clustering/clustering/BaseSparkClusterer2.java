 ...
 */
public class BaseSparkClusterer2 implements IClusterer {
    ...
    public BaseSparkClusterer2(SparkContext scArg, SimilarityMode mode, double simCutOff, int numPartitions) {
        this.sc = scArg;
        this.mode = mode;
