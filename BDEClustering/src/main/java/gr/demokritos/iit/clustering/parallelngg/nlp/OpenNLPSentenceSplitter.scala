package gr.demokritos.iit.clustering.parallelngg.nlp

import java.io.FileInputStream

import gr.demokritos.iit.clustering.parallelngg.structs.{StringAtom, StringEntity}
import gr.demokritos.iit.clustering.parallelngg.traits.{SentenceSplitter, Atom, Entity}
