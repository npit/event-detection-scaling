...
public class NewsCrawler extends AbstractCrawler {
    ...
    private static final Logger log = Logger.getLogger(NewsCrawler.class.getName());

    public NewsCrawler(SystemFactory factory, RSSConf configuration) throws Exception {
    ...
    public static void main(String[] args) { // TODO impl arg parsing
        RSSConf configuration = new RSSConf(DEFAULT_NEWS_CONFIGURATION);
