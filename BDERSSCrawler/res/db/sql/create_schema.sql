...
CREATE TABLE IF NOT EXISTS blog_articles (id INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), entry_url VARCHAR(1000) NOT NULL, UNIQUE KEY(entry_url), feed_url VARCHAR(1000) NOT NULL, crawl_id BIGINT NOT NULL, raw_text MEDIUMTEXT, clean_text MEDIUMTEXT, analysed_text MEDIUMTEXT, published BIGINT, crawled BIGINT NOT NULL, language VARCHAR(2));
CREATE TABLE IF NOT EXISTS news_articles (id INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), entry_url VARCHAR(1000) NOT NULL, UNIQUE KEY(entry_url), feed_url VARCHAR(1000) NOT NULL, crawl_id BIGINT NOT NULL, raw_text MEDIUMTEXT, clean_text MEDIUMTEXT, analysed_text MEDIUMTEXT, published BIGINT, crawled BIGINT NOT NULL, language VARCHAR(2));
