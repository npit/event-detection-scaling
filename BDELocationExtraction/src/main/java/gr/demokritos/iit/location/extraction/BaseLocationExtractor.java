 ...
 */
public class BaseLocationExtractor implements ILocationExtractor {
     ...
     */
    public BaseLocationExtractor(ITokenProvider token_provider) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ILocationExtractor ext = new BaseLocationExtractor(tp);
